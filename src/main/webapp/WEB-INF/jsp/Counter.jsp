...
<head>
    ...
    <script type="text/javascript" src="statics/localjs/salesManage/counter.js"></script>
    <!--[if IE 9]>
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="dataTables_wrapper" id="dyntable_wrapper">
                <%----%>
                    <div id="dyntable_length" class="dataTables_length">
                        <a href="/counterAdd" class="btn btn2 btn_archive" id="addCounter"><span>添加柜台销售计划</span></a>
                    </div>
                <%--end--%>
            ...
            <div class="dataTables_filter" id="dyntable_filter">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable" style="font-size: 12px;">
                    ...
                    <thead>
                    <tr>
                        <th class="head0 sorting" rowspan="1" colspan="1">柜台ID</th>
                        <th class="head0 sorting" rowspan="1" colspan="1">药品商用名称</th>
                        <th class="head1 sorting" rowspan="1" colspan="1" >通用名</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" >规格</th>
                        <th class="head1 sorting" rowspan="1" colspan="1" >生产家</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" >是否处方药</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" >金额</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" style="width: 50px;">数量</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" style="width: 80px;">货位名称</th>
                        <th class="head0 sorting" rowspan="1" colspan="1" style="width: 50px;">操作</th>

                    </tr>
                    </thead>
                    <tbody id="CounterInfoPage">

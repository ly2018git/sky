...
<ul>
    ...
    <li><a href="#salesManage" class="widgets">销售业务</a>
        <span class="arrow"></span>
        <ul id="salesManage">
            <li><a href="sellItem">药品销售列表</a></li>
            <li><a href="sellAccount">销售营业额</a></li>
            <li><a href="counter">柜台药品销售列表</a></li>
            <li><a href="shift">销售员交班</a></li>
        </ul>
    </li>
    ...
    <li><a href="#baobiao" class="tables">GPS报表</a>
        <span class="arrow"></span>
        <ul id="baobiao">
            <li><a href="gps/drugPurchaseGpsList">药品购进记录报表</a></li>
            <li><a href="gps/drugSalesGpsList">药品销售明细报表</a></li>
            <li><a href="gps/drugMaintainGpsList">药品养护报表</a></li>
        </ul>
    </li>
